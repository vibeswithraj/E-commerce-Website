...
const AllProducts = () => {
  const { catName, open, setOpen, allProducts } = useContext(productsContext);
  // #FF000D
  return (
    <div className="w-full h-full flex">
      ...
      <div className="w-full h-auto relative">
        <AdminNav />
        <div className="bg-[#e7e7e3] w-full h-auto px-4 py-5">
          ...
          <div className="w-full h-auto flex flex-wrap justify-center gap-6 mt-6">
                ...
                .filter((i) =>
                  catName === "all"
                    ...
                    : i.category
                      ...
                      i.title.toLowerCase().includes(catName.toLowerCase())
                )
                .map((items, index) => (
                  <div
                    key={index}
