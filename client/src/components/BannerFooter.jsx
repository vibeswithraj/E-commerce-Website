...
const BannerFooter = () => {
  return (
    <div className="w-full h-[360px] relative mt-[100px] flex justify-center items-center">
      <img src={banner} className='w-full h-[360px] object-cover' alt="" />
      <div className="absolute flex flex-col justify-center items-center sm:w-[540px] px-4 sm:px-0 w-full">
        <p className='sm:text-[40px] text-[30px] font-bold text-[#141718] text-center'>Join Our Newsletter</p>
        <p className='sm:text-lg text-base font-normal mb-8 text-center'>Sign up for deals, new products and promotions</p>
